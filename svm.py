# -*- coding: utf-8 -*-
"""
Created on Wed Nov 27 00:06:16 2019
...
classifier = SVC(kernel='poly',random_state=None,gamma='auto',decision_function_shape='ovo')
classification = classifier.fit(X_train,Y_train)
# Save the model as a pickle in a file 
svm_model = pickle.dumps(classification)
saved_model = pickle.loads(svm_model)
